...
export class QnBank1743276179761 implements MigrationInterface {
    name = 'QnBank1743276179761'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "student_score" ("sc_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "score" character varying NOT NULL, "sc_created_at" TIME WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "sc_updated_at" TIME WITH TIME ZONE NOT NULL DEFAULT 'NOW()', "sc_deleted_at" TIME WITH TIME ZONE, "qb_id" uuid, "u_id" uuid, CONSTRAINT "PK_cd29684daa204df497ea7cfa73f" PRIMARY KEY ("sc_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "student_score" ADD CONSTRAINT "FK_bd077cc7b904e60063a514a1bd9" FOREIGN KEY ("qb_id") REFERENCES "qn_bank"("qb_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "student_score" ADD CONSTRAINT "FK_bce628835a0202cbc8b5f09bab8" FOREIGN KEY ("u_id") REFERENCES "users"("u_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "student_score" DROP CONSTRAINT "FK_bce628835a0202cbc8b5f09bab8"`);
        await queryRunner.query(`ALTER TABLE "student_score" DROP CONSTRAINT "FK_bd077cc7b904e60063a514a1bd9"`);
